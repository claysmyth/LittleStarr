...
session_type = strrep(file_paths.SessionType_s_{ind}, ' ', '_');
...
% 
% parquet_out_path_full = [OUT_PATH_BASE, '/', append(file_paths.RCS_{ind}, file_paths.Side{ind}(1)), ...
%     '/', session_type, '/', parquet_file_name{1}];
% 
% eventlog_out_path_full = [OUT_PATH_BASE, '/', append(file_paths.RCS_{ind}, file_paths.Side{ind}(1)), ...
%     '/', session_type, '/', eventLog_file_name{1}];


parquet_out_path_full = fullfile(OUT_PATH_BASE, append(file_paths.RCS_{ind}, file_paths.Side{ind}(1)), ...
    session_type, parquet_file_name{1});

eventlog_out_path_full = fullfile(OUT_PATH_BASE, append(file_paths.RCS_{ind}, file_paths.Side{ind}(1)), ...
    session_type, eventLog_file_name{1});
